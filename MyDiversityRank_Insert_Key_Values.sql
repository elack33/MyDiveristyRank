...
INSERT INTO BirthYear (BirthYear)
...
VALUES ('CIS Female'), ('CIS Male'), ('MTF'), ('FTM'), ('Other');

INSERT INTO Interests (Interests)
VALUES ('Geekdom'), ('Tabletop Gaming'), ('Nerd Things'), ('Square Dancing'), 
	('Book Club'), ('Hobbys/crafts'), ('Video Games'), ('School/Classes'), 
...
VALUES ('Developer/IT'), ('STEM Field'), ('Customer Service'), ('Data Services'), 
	('Web Services'), ('Food Services'), ('Student'), ('Manufacturing'), ('Other');
